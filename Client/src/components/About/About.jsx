...
const About = () => {
    ...
    const techSkills = [{ tech: 'Html', image: htmlImg }, { tech: 'Css', image: cssImg }, { tech: 'JavaScript', image: javascriptImg }, { tech: 'React', image: reactImg }, { tech: 'Redux', image: redux }, { tech: 'Express', image: express }]

    return(
        <div className={style.divBienvenido}>
            <h1 className={style.subtitle}>Elias Martinez</h1>
            <h3 className={style.h3About}>Cohorte: FT-37a</h3>
